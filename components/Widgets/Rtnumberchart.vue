    ...
    export default {
        ...
        methods: {
            ...
            updateColorClass() {
                ...
                if (c == "success") {
                    this.chartOptions.series[0].color = "#B7FF8A";
                }
                if (c == "primary") {
                    this.chartOptions.series[0].color = "#8AC4FF";
                }
                if (c == "warning") {
                    this.chartOptions.series[0].color = "#ffa65e";
                }
                if (c == "danger") {
                    this.chartOptions.series[0].color = "#FDFB80";
                }
